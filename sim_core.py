...
def build_default_params(years: int = 5) -> SimParams:
    ...
    # 초기 인원: 하위 단계 많고 상위로 갈수록 적은 피라미드
    initial = {
        "P": {"P1": 900, "P2": 620, "P3": 340, "P4": 140},
        "R": {"CL1": 300, "CL2": 260, "CL3": 210, "CL4": 150, "CL5": 90, "CL6": 40},
        "E": {"E1": 700, "E2": 640, "E3": 520, "E4": 380, "E5": 240, "E6": 120, "E7": 50},
        "A": {"A1": 260, "A2": 160, "A3": 70},
    }
