...
def build_default_params(years: int = 5) -> SimParams:
    ...
    # 초기 인원: '모래시계형' — 하위(신입)와 상위(고참)가 두껍고 허리(중간 단계)가 얇다.
    #   (실무 현황 가정: 저연차·고연차 편중, 중간 관리 계층 공동화)
    #   레버 조정으로 이 형태를 피라미드로 되돌리는 것이 데모의 스토리라인이다.
    initial = {
        "P": {"P1": 760, "P2": 300, "P3": 340, "P4": 600},
        "R": {"CL1": 330, "CL2": 140, "CL3": 90, "CL4": 110, "CL5": 180, "CL6": 200},
        "E": {"E1": 780, "E2": 340, "E3": 190, "E4": 160, "E5": 300, "E6": 420, "E7": 460},
        "A": {"A1": 250, "A2": 90, "A3": 150},
    }
